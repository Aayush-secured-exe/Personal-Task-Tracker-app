  ...
  const StatCard = ({ title, value, icon }) => (
    ...
    >
      <div className="flex items-center gap-2">
        <div
          className="p-1.5 rounded-lg bg-linear-to-br from-fuchsia-500/10 to-purple-500/10 
        ...
        <div className="min-w-0">
          <p
            className="text-lg sm:text-xl font-bold bg-linear-to-r from-fuchsia-500 to-purple-600 
          ...
          <div className="xl:col-span-1 space-y-4 sm:space-y-6">
                ...
                <div className="relative pt-1">
                  <div className="flex gap-1.5 items-center">
                    <div className="flex-1 h-2 sm:h-3 bg-purple-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-linear-to-r from-fuchsia-500 to-purple-600 transition-all
                       duration-500"
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                {tasks.length === 0 && (
                  <div className="text-center px-2 py-4 sm:py-6">
                    <div
                      className="w-12 h-12 sm:w-16 sm:h-16 mx-auto sm:mb-4 rounded-full bg-purple-100
